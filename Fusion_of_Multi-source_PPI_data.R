################################################################################
#Author: Liu Zhu
#This part of the code is mainly used for 
#the fusion of multisource protein interaction data
################################################################################
...
write.table(All_PPI, file = 'DATA/2-ALL Proteins/ALL_PPI_Data_0.3.txt',sep = " ",row.names =FALSE, col.names =FALSE, quote =FALSE)
